...
# --- exposure (numeric photons_per_unit) ----------------------------------


def test_exposure_scales_counts_and_stays_within_adc():
    # photons_per_unit is the exposure scale: a brighter exposure produces larger
    # counts (more detected photons), and the digitized movie never exceeds the ADC
    # ceiling. Explicit shallow, in-focus positions keep the placement deterministic.
